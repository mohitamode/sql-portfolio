# SQL Portfolio - Mohit Shyam Amode

Welcome to my SQL Portfolio repository.

This repository is a comprehensive collection of SQL case studies, solutions to problems from various platforms, and advanced projects, all designed to demonstrate proficiency in SQL.
...
This repository serves as a valuable resource for SQL practitioners, offering a variety of case studies, platform solutions, projects, and takehome challenges. Whether you are a beginner or an advanced user, these resources are designed to enhance your SQL skills through practical applications and complex problem-solving scenarios.
...
Each case study presents a real-world business scenario, and you are tasked with answering a series of questions using SQL queries. This repository contains solutions to the challenges, along with explanations and additional resources used.

The solutions for each case study are provided in the respective case study folder.

## Solutions by Platform

This section includes SQL problems and solutions from 8 different platforms, each organized into directories. 

Each platform directory is further divided into subdirectories based on the difficulty level: easy, medium, and hard.
...
| [Restaurant Ratings Analysis](./projects/restaurant-ratings-analysis/) | Restaurant performance, customer preferences, sentiment analysis | Analyze restaurant ratings data to understand factors influencing ratings, with insights for performance enhancement. |  
...
1. Clone the repository:
    ...
    ```sh
    git clone https://github.com/mohitamode/sql-portfolio.git
    ```
...
I hope you find these resources informative and useful for your SQL learning and application. Should you have any questions or feedback, feel free to reach out to me on [LinkedIn](https://www.linkedin.com/in/mohitamode/) or via email at mohitshyamamode@gmail.com.

## About the Developer

Mohit Shyam Amode is a Data Analyst with over 4 years of professional experience specializing in dashboard development, SQL query optimization, and structured data analysis. With a background in translating operational requirements into actionable insights, Mohit maintains this repository as a comprehensive resource for data professionals. This project builds upon foundational SQL work by Faizan Mulla and is currently updated and maintained by Mohit to reflect advanced analytical standards.