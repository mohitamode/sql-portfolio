...
<p>
This project is maintained by Mohit Shyam Amode, a Data Analyst with over 4 years of professional experience in SQL, dashboard development, and structured data analysis. Mohit specializes in query optimization, data visualization, and translating complex operational requirements into actionable insights.
</p>

<p>
<strong>Technical Expertise:</strong>
<ul>
  <li>Languages: Python, SQL, R, JavaScript, C, C++</li>
  <li>Tools: Tableau, Power BI, MongoDB, R Shiny, Streamlit</li>
  <li>Specializations: Reporting workflows, JSON data handling, and LangChain</li>
</ul>
</p>
...
LinkedIn: <a href="https://linkedin.com/in/mohitamode">linkedin.com/in/mohitamode</a>
</p>