...
This project is maintained by Mohit Shyam Amode, a Data Analyst with over 4 years of professional experience in SQL, dashboard development, and structured data analysis. Mohit specializes in query optimization, reporting workflows, and translating complex operational requirements into actionable insights.

**Key Skills:**
- Languages: Python, SQL, R, JavaScript, C, C++
- Tools: Tableau, Power BI, MongoDB, R Shiny, Streamlit
- Expertise: Data Visualization, JSON handling, LangChain
