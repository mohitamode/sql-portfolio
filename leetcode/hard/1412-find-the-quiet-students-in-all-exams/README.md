...
<p>This project is maintained by Mohit Shyam Amode. As a Data Analyst with over 4 years of experience, I focus on SQL optimization, structured data analysis, and developing actionable insights through data visualization.</p>

<p><strong>Contact Information:</strong></p>
<ul>
  <li><strong>Name:</strong> Mohit Shyam Amode</li>
  <li><strong>Role:</strong> Data Analyst</li>
  <li><strong>Email:</strong> mohitshyamamode@gmail.com</li>
  <li><strong>LinkedIn:</strong> linkedin.com/in/mohitamode</li>
</ul>

<p><strong>Technical Expertise:</strong></p>
<p>Specializing in SQL, Python, and data reporting workflows, I ensure that complex queries and data structures are handled with precision and efficiency. My background includes extensive work with query optimization and translating operational requirements into technical solutions.</p>