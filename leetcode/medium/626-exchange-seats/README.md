...
Professional with 4+ years of experience in SQL, Python, and structured data analysis. Specialized in query optimization, data visualization, and translating complex operational requirements into actionable insights.

- **Email:** mohitshyamamode@gmail.com
- **LinkedIn:** linkedin.com/in/mohitamode
- **Key Skills:** SQL, Python, R, JavaScript, C, C++, Streamlit, LangChain, Tableau, Power BI