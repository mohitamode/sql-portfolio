...
Data Preparation : (refer [schema.sql](schema.sql))
...
Feature Engineering : (refer [schema.sql](schema.sql))
...
Exploratory Data Analysis (EDA) : (refer [solution.md](solution.md))
...
Please refer to [insights.md](insights.md) for a detailed breakdown of the findings.
...
If you have any doubts, queries, or suggestions, please connect with me on [LinkedIn](https://linkedin.com/in/mohitamode).
...
Mohit Shyam Amode is a Data Analyst with over 4 years of professional experience in SQL, Python, and structured data analysis. He specializes in query optimization, data visualization, and translating operational requirements into actionable dashboard insights. With a strong background in tools like Tableau, Power BI, and LangChain, he focuses on delivering data-driven solutions for complex business problems.

Contact: mohitshyamamode@gmail.com